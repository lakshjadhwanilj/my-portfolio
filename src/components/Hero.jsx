...
const Hero = () => {
    return (
        <div className='flex flex-col lg:flex-row gap-[50px]'>
            <div className='textContainer text-white flex-1 justify-center items-center my-auto'>
