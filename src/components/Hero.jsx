        ...
        <div className='hero flex flex-col md:flex-row gap-7 lg:gap-12'>
            <div className='textContainer flex-1 justify-center items-center my-auto'>
                ...
                <div className='flex justify-center md:justify-normal gap-5 my-5'>
                    <Link href={`mailto:${EMAIL_ID}`} target='_blank' className='btn py-3 px-3 min-w-[8rem] border-none rounded font-bold uppercase tracking-wider text-sm'>
                        <AiTwotoneMail className='inline mb-[3px] text-lg'/> Hire Me
                    </Link>
                    <Link href={RESUME_LINK} target='_blank' className='btn-invert py-3 px-3 min-w-[8rem] border-none rounded font-bold uppercase tracking-wider text-sm'>
