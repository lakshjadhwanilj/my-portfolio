...
const Quote = () => {
  return (
    <div className="quote grid grid-cols-3 py-5 rounded-[10px]">
        <div className="col-span-1 px-6">
            <Image src={LakshImage} alt="Laksh Jadhwani" className="rounded-full h-auto w-full border-4 border-white" />
        </div>
        <div className="col-span-2 py-2 px-11 rounded-3xl ">
